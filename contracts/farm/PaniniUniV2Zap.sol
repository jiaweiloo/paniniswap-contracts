...
contract PaniniUniV2Zap {
    ...
    function beefInETH (address beefyVault, uint256 tokenAmountOutMin) external payable {
        ...
        _swapAndStake(beefyVault, tokenAmountOutMin, WAVAX);
    }
    ...
    function checkWAVAX() public view returns (bool isValid) {
        isValid = WAVAX == router.WAVAX();
        require(isValid, 'Beefy: WAVAX address not matching Router.WAVAX()');
    }
